...
console.log(`Je m’appelle ${moi["prenom"]} ${moi["nom"]}, j’ai ${moi["age"]} ans, je suis ${moi["nationalite"]} et je suis ${moi["profession"]}`)
...
console.log(`Je m’appelle ${moi.prenom} ${moi.nom}, j’ai ${moi.age} ans, je suis ${moi.nationalite} et je suis ${moi.statut}`)
